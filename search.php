                        ...
                        <?php
                            if (isset($_POST['searchBtn'])) {
                               $search_content = $_POST['search'];
                                ...
                                $allSearchPost=mysqli_query($connect,$query);
                                $total_post=mysqli_num_rows($allSearchPost);
                                if($total_post == 0 || $total_post<0){
                                    echo '
                                    <div class="alert alert-warning"><h3 class="text-center">No Found Post in your Search Result</h3></div>' ;
                                }
                                else {
