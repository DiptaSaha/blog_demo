            ...
            <div class="row">
                ...
                <div class="col-md-8">
                        ...
                        <?php
                            if (isset($_GET['id'])) {
                               $theCatId = $_GET['id'];
                                $query="SELECT * FROM post WHERE post_category ='$theCatId'";
                                $allPost=mysqli_query($connect,$query);
                                $total_post=mysqli_num_rows($allPost);
                                if($total_post == 0 || $total_post<0){
                                    echo '
                                    <div class="alert alert-warning"><h3 class="text-center">No Found Post</h3></div>' ;
                                }
                                else {
                             
                            $sql="SELECT * FROM post WHERE post_category ='$theCatId' ORDER BY post_id DESC";
